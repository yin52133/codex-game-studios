---
name: patch-notes
description: "Generate player-facing patch notes from git history, sprint data, and internal changelogs. Translates developer language into clear, engaging player communication. (source alias: /patch-notes)."
---
...
- Source workflow alias: `/patch-notes`.
...
- Source argument hint: `[version] [--style brief|detailed|full]`.
...
1. Check `references/docs/technical-preferences.md` for any "tone", "voice", or "style"
   fields or sections.
...
1. file search for `docs/patch-notes-template.md` and `references/templates/patch-notes-template.md`.
