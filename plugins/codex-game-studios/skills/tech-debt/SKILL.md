---
name: tech-debt
description: "Track, categorize, and prioritize technical debt across the codebase. Scans for debt indicators, maintains a debt register, and recommends repayment scheduling. (source alias: /tech-debt)."
---
...
- Source workflow alias: `/tech-debt`.
...
- Source argument hint: `[scan|add|prioritize|report]`.
...
Then use `request user input` to collect the **category**:
...
Then use `request user input` to collect the **estimated fix effort**:
