...
description: "Generates a comprehensive pre-release validation checklist covering build verification, certification requirements, store metadata, and launch readiness. (source alias: /release-checklist)."
---
...
- Source workflow alias: `/release-checklist`.
...
- Source argument hint: `[platform: pc|console|mobile|all]`.
