...
- Source workflow alias: `/sprint-status`.
...
- Source argument hint: `[sprint-number or blank for current]`.
...
| Story / Codex sub-agent delegation         | Priority   | Status      | Owner   | Blocker        |
|----------------------|------------|-------------|---------|----------------|
...
### Attention Needed
| Story / Codex sub-agent delegation         | Status      | Last Updated   | Days Stale | Note           |
|----------------------|-------------|----------------|------------|----------------|
