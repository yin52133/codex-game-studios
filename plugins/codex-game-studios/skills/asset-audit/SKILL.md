---
name: asset-audit
description: "Audits game assets for compliance with naming conventions, file size budgets, format standards, and pipeline requirements. Identifies orphaned assets, missing references, and standard violations. (source alias: /asset-audit)."
---
...
- Source workflow alias: `/asset-audit`.
...
- Source argument hint: `[category|all]`.
