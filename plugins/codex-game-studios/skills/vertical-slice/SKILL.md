...
- Source workflow alias: `/vertical-slice`.
...
- Naming conventions from `references/docs/technical-preferences.md`
...
Read `references/templates/vertical-slice-report.md` to get the report structure.
...
- `full` → spawn `creative-director` via Codex sub-agent delegation using gate **CD-PLAYTEST**
  (`references/docs/director-gates.md`).
