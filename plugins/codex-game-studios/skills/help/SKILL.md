---
name: help
description: "Analyzes what is done and the users query and offers advice on what to do next. Use if user says what should I do next or what do I do now or I'm stuck or I don't know what to do (source alias: /help)."
---
...
- Source argument hint: `[optional: what you just finished, e.g. 'finished design-review' or 'stuck on ADRs']`.
...
Read `references/docs/workflow-catalog.yaml`. This is the authoritative list of all
...
After reading the catalog, file search `skills/*/SKILL.md` to get the full list
...
- If `artifact.pattern` is specified, use rg search to verify the pattern exists in the matched file
