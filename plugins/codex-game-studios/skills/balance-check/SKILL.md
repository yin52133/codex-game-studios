...
- Source workflow alias: `/balance-check`.
...
- Source argument hint: `[system-name|path-to-data-file]`.
...
After presenting the report, use `request user input`:
