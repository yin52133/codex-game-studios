---
name: team-ui
description: "Orchestrate the UI team through the full UX pipeline: from UX spec authoring through visual design, implementation, review, and polish. Integrates with /ux-design, /ux-review, and studio UX templates. (source alias: /team-ui)."
---
...
- Source argument hint: `[UI feature description] [--review full|lean|solo]`.

## Ported Workflow
When this skill is invoked, orchestrate the UI team through a structured pipeline.

**Decision Points:** At each phase transition, use `request user input` to present
...
- **engine UI specialist** — Validates UI implementation patterns against engine-specific best practices (read from `references/docs/technical-preferences.md` Engine Specialists → UI Specialist)
...
Then use `request user input` with options:
...
Before implementation begins, spawn the **engine UI specialist** (from `references/docs/technical-preferences.md` Engine Specialists → UI Specialist) to review the UX spec and visual design spec for engine-specific implementation guidance:
