---
name: ux-review
description: "Validates a UX spec, HUD design, or interaction pattern library for completeness, accessibility compliance, GDD alignment, and implementation readiness. Produces APPROVED / NEEDS REVISION / MAJOR REVISION NEEDED verdict with specific gaps. (source alias: /ux-review)."
---
...
- Source workflow alias: `/ux-review`.
...
- Source argument hint: `[file-path or 'all' or 'hud' or 'patterns']`.
...
1. **Input & Platform config**: Read `references/docs/technical-preferences.md` and
