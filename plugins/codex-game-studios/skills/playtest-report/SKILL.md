...
description: "Generates a structured playtest report template or analyzes existing playtest notes into a structured format. Use this to standardize playtest feedback collection and analysis. (source alias: /playtest-report)."
---
...
- Source workflow alias: `/playtest-report`.
...
- Source argument hint: `[new|analyze path-to-notes] [--review full|lean|solo]`.
...
After categorising findings, spawn `creative-director` via Codex sub-agent delegation using gate **CD-PLAYTEST** (`references/docs/director-gates.md`).
