---
name: onboard
description: "Generates a contextual onboarding document for a new contributor or agent joining the project. Summarizes project state, architecture, conventions, and current priorities relevant to the specified role or area. (source alias: /onboard)."
---
...
- Source argument hint: `[role|area]`.
...
Read the relevant agent definition from `references/roles/` if a specific role is specified.
