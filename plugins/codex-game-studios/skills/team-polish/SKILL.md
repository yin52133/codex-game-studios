---
name: team-polish
description: "Orchestrate the polish team: coordinates performance-analyst, technical-artist, sound-designer, and qa-tester to optimize, polish, and harden a feature or area for release quality. (source alias: /team-polish)."
---
...
- Source workflow alias: `/team-polish`.
...
- Source argument hint: `[feature or area to polish] [--review full|lean|solo]`.

## Ported Workflow
If no argument is provided, output usage guidance and exit without spawning any agents:
> Usage: `/team-polish [feature or area]` — specify the feature or area to polish (e.g., `combat`, `main menu`, `inventory system`, `level-1`). Do not use `request user input` here; output the guidance directly.
