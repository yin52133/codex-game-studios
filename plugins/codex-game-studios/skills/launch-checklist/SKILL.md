...
description: "Complete launch readiness validation covering every department: code, content, store, marketing, community, infrastructure, legal, and go/no-go sign-offs. (source alias: /launch-checklist)."
---
...
- Source workflow alias: `/launch-checklist`.
...
- Source argument hint: `[launch-date or 'dry-run']`.
