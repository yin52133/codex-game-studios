...
description: "Generate design or architecture documents from existing implementation. Works backwards from code/prototypes to create missing planning docs. (source alias: /reverse-document)."
---
...
- Source workflow alias: `/reverse-document`.
...
- Source argument hint: `<type> <path> (e.g., 'design src/gameplay/combat' or 'architecture src/core')`.
