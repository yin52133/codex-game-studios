---
name: team-combat
description: "Orchestrate the combat team: coordinates game-designer, gameplay-programmer, ai-programmer, technical-artist, sound-designer, and qa-tester to design, implement, and validate a combat feature end-to-end. (source alias: /team-combat)."
---
...
- Source workflow alias: `/team-combat`.
...
- Source argument hint: `[combat feature description] [--review full|lean|solo]`.
...
- **engine specialist** (primary) — Validate architecture and implementation patterns are idiomatic for the engine (read from `references/docs/technical-preferences.md` Engine Specialists section)
...
delegated to sub-agents spawned via Codex sub-agent delegation. Each sub-agent enforces the
