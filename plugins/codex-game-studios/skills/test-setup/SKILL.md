---
name: test-setup
description: "Scaffold the test framework and CI/CD pipeline for the project's engine. Creates the tests/ directory structure, engine-specific test runner configuration, and GitHub Actions workflow. Run once during Technical Setup phase before the first sprint begins. (source alias: /test-setup)."
---
...
- Source workflow alias: `/test-setup`.
...
1. **Read engine config**:
   - Read `references/docs/technical-preferences.md` and extract the `Engine:` value.
