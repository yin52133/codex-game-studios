---
name: bug-triage
description: "Read all open bugs in production/qa/bugs/, re-evaluate priority vs. severity, assign to sprints, surface systemic trends, and produce a triage report. Run at sprint start or when the bug count grows enough to need re-prioritization. (source alias: /bug-triage)."
---
...
- Source workflow alias: `/bug-triage`.
...
- Source argument hint: `[sprint | full | trend]`.
...
Read `references/docs/coding-standards.md` for severity/priority definitions if they
