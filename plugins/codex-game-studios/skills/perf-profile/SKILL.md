---
name: perf-profile
description: "Structured performance profiling workflow. Identifies bottlenecks, measures against budgets, and generates optimization recommendations with priority rankings. (source alias: /perf-profile)."
---
...
- Source workflow alias: `/perf-profile`.
...
- Source argument hint: `[system-name or 'full']`.
