...
description: "Automatically analyze project state, detect stage, identify gaps, and recommend next steps based on existing artifacts. Use when user asks 'where are we in development', 'what stage are we in', 'full project audit'. (source alias: /project-stage-detect)."
---
...
- Source workflow alias: `/project-stage-detect`.
...
- Source argument hint: `[optional: role filter like 'programmer' or 'designer']`.
...
Use template: `references/templates/project-stage-report.md`
