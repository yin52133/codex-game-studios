---
name: estimate
description: "Estimates task effort by analyzing complexity, dependencies, historical velocity, and risk factors. Produces a structured estimate with confidence levels. (source alias: /estimate)."
---
...
- Source workflow alias: `/estimate`.
...
- Source argument hint: `[task-description]`.

## Ported Workflow
## Phase 1: Understand the Codex sub-agent delegation
...
```markdown
## Codex sub-agent delegation Estimate: [Codex sub-agent delegation Name]
Generated: [Date]

### Codex sub-agent delegation Description
