---
name: team-narrative
description: "Orchestrate the narrative team: coordinates narrative-director, writer, world-builder, and level-designer to create cohesive story content, world lore, and narrative-driven level design. (source alias: /team-narrative)."
---
...
- Source workflow alias: `/team-narrative`.
...
- Source argument hint: `[narrative content description] [--review full|lean|solo]`.

## Ported Workflow
If no argument is provided, output usage guidance and exit without spawning any agents:
> Usage: `/team-narrative [narrative content description]` — describe the story content, scene, or narrative area to work on (e.g., `boss encounter cutscene`, `faction intro dialogue`, `tutorial narrative`). Do not use `request user input` here; output the guidance directly.
...
Delegate in parallel — issue all three Codex sub-agent delegation calls simultaneously before waiting for any result:
...
sub-agents spawned via Codex sub-agent delegation. Each sub-agent enforces the "May I write to [path]?"
