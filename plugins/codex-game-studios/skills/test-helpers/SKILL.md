---
name: test-helpers
description: "Generate engine-specific test helper libraries for the project's test suite. Reads existing test patterns and produces tests/helpers/ with assertion utilities, factory functions, and mock objects tailored to the project's systems. Reduces boilerplate in new test files. (source alias: /test-helpers)."
---
...
- Source workflow alias: `/test-helpers`.
...
- Source argument hint: `[system-name | all | scaffold]`.
...
Read `references/docs/technical-preferences.md` and extract:
- `Engine:` value
- `Language:` value
