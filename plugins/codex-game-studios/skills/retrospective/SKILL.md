---
name: retrospective
description: "Generates a sprint or milestone retrospective by analyzing completed work, velocity, blockers, and patterns. Produces actionable insights for the next iteration. (source alias: /retrospective)."
---
...
- Source workflow alias: `/retrospective`.
...
- Source argument hint: `[sprint-N|milestone-name]`.
...
If a matching file is found, use `request user input`:
...
Then use `request user input` to present two options:
...
| Codex sub-agent delegation | Estimated | Actual | Variance | Likely Cause |
|------|-----------|--------|----------|--------------|
...
| Codex sub-agent delegation | Original Sprint | Times Carried | Reason | Action |
|------|----------------|---------------|--------|--------|
| [Codex sub-agent delegation that was not completed] | [Sprint N-X] | [N] | [Why] | [Complete / Descope / Redesign] |
