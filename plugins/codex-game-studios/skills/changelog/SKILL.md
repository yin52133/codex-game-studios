---
name: changelog
description: "Auto-generates a changelog from git commits, sprint data, and design documents. Produces both internal and player-facing versions. (source alias: /changelog)."
---
...
- Source workflow alias: `/changelog`.
...
- Source argument hint: `[version|sprint-number]`.
