...
| `model` | `sonnet` |
| `name` | `prototyper` |
| `tools` | `Read, file search, rg search, Write, Edit, Bash` |
...
Use template: `references/templates/prototype-report.md`

**Vertical slice** → `prototypes/[name]-vertical-slice/REPORT.md`
Use template: `references/templates/vertical-slice-report.md`
